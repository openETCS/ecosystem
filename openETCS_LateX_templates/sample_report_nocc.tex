\documentclass{template/openetcs_report_nocc}
...
%set a subtitle here
\subtitle{The introduction of openETCS's \LaTeX class, Version~1.0}

%set the date of the report here
\date{August 2012\\Revised August 2012}
